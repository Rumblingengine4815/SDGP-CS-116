...
export default function HomePage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "As someone switching from marketing, the personalised pathway made my learning plan clear. I landed an data analyst role in 8 months.",
      img: "/team/p2.jpg"
    },
    {
      name: "Amaara Silva",
  ...
  return (
    <div className="min-h-screen bg-purple-50 text-slate-900 selection:bg-purple-100">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <nav className="flex items-center justify-between py-8">
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className="h-8 w-8 rounded-lg bg-purple-600 transition-transform group-hover:rotate-12" />
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <Link href="/login" className="rounded-full bg-slate-900 px-6 py-2.5 text-sm font-semibold text-white shadow-xl transition hover:bg-slate-800 hover:scale-105 active:scale-95">
              Get Started
            </Link>
          </div>
        </nav>
        ...
        <header className="py-24 text-center">
          <div className="inline-flex items-center rounded-full border border-purple-100 bg-purple-50/50 px-3 py-1 mb-6">
            <span className="text-xs font-bold uppercase tracking-wider text-purple-600">New: AI Mentor 2.0 is live</span>
          </div>
          <h1 className="mx-auto max-w-4xl text-5xl font-extrabold tracking-tight md:text-7xl">
            Navigate your future with <span className="block text-purple-600">absolute confidence.</span>
          </h1>
          <p className="mt-8 mx-auto max-w-2xl text-lg text-slate-600 leading-relaxed">
            Stop guessing your career path. Use data-driven insights and AI mentorship to bridge the gap between your current skills and your dream role.
          </p>
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link href="/how-it-works" className="w-full sm:w-auto rounded-xl bg-purple-600 px-8 py-4 text-white font-bold shadow-lg shadow-purple-200 transition hover:bg-purple-700 hover:-translate-y-0.5">
              Build Your Pathway
            </Link>
            <Link href="/data-sources" className="w-full sm:w-auto rounded-xl border border-slate-200 bg-white px-8 py-4 font-bold text-slate-600 transition hover:bg-slate-50 hover:border-slate-300">
              View Market Trends
            </Link>
          </div>
        </header>

        {/* Features Grid - Improved Card UI */}
