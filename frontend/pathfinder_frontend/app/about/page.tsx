...
export default function AboutPage() {
  const teamMembers = [
    ...
    },
    {
      ...
      image:
        "https://ui-avatars.com/api/?name=Nithila+Mandiw&size=256&background=7c3aed&color=fff",
    ...
    },
    {
      ...
      role: "Bot Developer",
      image:
        "https://ui-avatars.com/api/?name=Thathsara+Samarakoon&size=256&background=7c3aed&color=fff",
    ...
    },
    {
      ...
      image:
        "https://ui-avatars.com/api/?name=Dineth+Weerasekara&size=256&background=7c3aed&color=fff",
  ...
  return (
    <section className="py-12 bg-content1 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            The people building PathFinder+ — combining AI,ML and grit with
            design to revolutionize career guidance for everyone.
          </p>
        </div>
        ...
        <div className="mt-12 sm:mt-16">
          <svg
            className="w-auto h-4 mx-auto text-purple-100"
            viewBox="0 0 172 16"
            fill="none"
            stroke="currentColor"
